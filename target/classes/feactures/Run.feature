...
Característica: Registro del nuevo empleado
  ...
  Escenario: Registra nuevo empleado
    ...
    Cuando el agrega Admin , admin123 , Cristian , Manuel , Ramos , 011272 , Cramos , 011346 , 406578, 2023-07-01 , 407631 , 12345 , 1994-07-13 , 1022345678 , Cristian Manuel Ramos al formulario
